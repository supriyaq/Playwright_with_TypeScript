//data Driven testing using data driven tetsing//


import { test, expect, Locator } from '@playwright/test';
import fs from 'fs';

const jsonFilePath:string='TestData_Folder/jsonFile.json';
const loginTestData:any= JSON.parse(fs.readFileSync(jsonFilePath,'utf-8'));
